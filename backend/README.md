...
## Project Structure
    ...
    ├── elearning_app_templ_37749  # Django project configurations
...
1. Clone this repo and `cd elearning_app_templ_37749`
...
2. Clone this repo and `cd elearning_app_templ_37749`
